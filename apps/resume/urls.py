...
urlpatterns = [
    path('resume/', TemplateView.as_view(template_name="resume/my-resume.html"), name='resume'),
    ...
    path('contact/', TemplateView.as_view(template_name="resume/contact.html"), name='contact'),
]
